    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <div class="card-tools">
                                                        <div class="input-group input-group-sm" style="width: 150px;">
                                                            <input type="text" name="table_search"  id="categorySearch" class="form-control float-right" placeholder="Search">
                                                ...
                                                <div class="card-body table-responsive p-0" style="height: 600px;">
                                                    <table class="table table-head-fixed text-nowrap" id="category" >
                                                        <thead>
                                                            <tr>
                                                                <th>S.r</th>
                                                                <th>Category Name</th>
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header" id="category-modal-header">
                                                                              ...
                                                                              <!-- form start -->
                                                                            <form method="POST" id="edit_categoryform" action = "/category/update/{{ $item->Id }}" >
                                                                                @csrf
                                                                                @method('PUT')
                                                    ...
                                                    <form action="/category/store" method="POST">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="name" id="exampleInputname" for="exampleInputname-error" value="{{ old('name') }}" placeholder="Enter Category Name" autocomplete="off">
                                                                @error('name')
                                                                <span id="exampleInputname-error" class="error text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="card-footer">
                                                            <button type="submit" class="bg-indigo btn btn-lg">Submit</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <!-- /.card-body -->
                ...
                <div class="col-12">
                   {{-- <img src="{{ asset('storage/uploads/User-Avatar-Profile-PNG.png') }}" alt="" srcset=""> --}}
                </div>
                <!-- /.col -->
            </div>
        </div>
